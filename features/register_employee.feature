Feature: Register employee
  ...
  @javascript
  Scenario: Check for page with register employee form
    Given I am on homepage
    When I follow "Registrering for Arbeidstakere"
    Then I should be at URL "/registrer-arbeidssokar"
    And I should see "Registrer deg pa framtidsfylket!"
